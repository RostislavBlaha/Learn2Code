...
fs.readFile('./package.json', (err, content) => {
  ...
  dependencies.forEach(dependency => {
    if (TRACKED_MODULES[dependency]) FOUND_MODULES.push(dependency)
  })

  FOUND_MODULES.forEach(module => {
    console.log(`Uh-oh. Module “${module}” is being used.
